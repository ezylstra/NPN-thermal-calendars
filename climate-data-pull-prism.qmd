...
if (need_yest_only == FALSE & up_to_date == FALSE) {
  ...
  for (i in 1:length(dates)) {
    ...
    tmin_file <- paste0(prism_folder, "/PRISM_tmin_early_4kmD2_", 
                        date_nodash, "_bil/PRISM_tmin_early_4kmD2_",
                        date_nodash, "_bil.bil")
    tmax_file <- paste0(prism_folder, "/PRISM_tmax_early_4kmD2_", 
                        date_nodash, "_bil/PRISM_tmax_early_4kmD2_",
                        date_nodash, "_bil.bil")
...
#### See whether this step is needed....
